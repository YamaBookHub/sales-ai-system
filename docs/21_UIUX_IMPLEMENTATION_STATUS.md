...
| UX-A03 | complete | UX-A02 | 2026-07-12 / uncommitted / npm test -- --runInBand OK / npm run build OK | dashboard README |
...
| UX-A03 | 2026-07-12 | GPT-5 | T1 | high | start | dashboard module README追加。現行surfaceではモデル変更せず実行 | complete: uncommitted |
